...
public class ExpansionHeader extends ConstraintLayout {
    ...
    private int headerRotationExpanded = 180;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        if (attrs != null) {
            ...
            setHeaderRotationExpanded(a.getInt(R.styleable.ExpansionHeader_expansionHeaderIndicatorRotationExpanded, headerRotationExpanded));
            setHeaderRotationCollapsed(a.getInt(R.styleable.ExpansionHeader_expansionHeaderIndicatorRotationCollapsed, headerRotationCollapsed));
            setHeaderIndicatorId(a.getResourceId(R.styleable.ExpansionHeader_expansionHeaderIndicator, headerIndicatorId));
            setExpansionLayoutId(a.getResourceId(R.styleable.ExpansionHeader_expansionLayoutHeader, expansionLayoutId));
            setToggleOnClick(a.getBoolean(R.styleable.ExpansionHeader_expansionToggleOnClick, toggleOnClick));
            a.recycle();
        }
    }
